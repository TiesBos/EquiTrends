...
#   # Data
  ...
  expect_no_error(maxEquivTest(Y= Y_data, ID= ID_data, G = G_data, period = period_data, X=X_data, equiv_threshold = 1, pretreatment_period = 1:5,
   ...
   expect_error(maxEquivTest(Y= Y_data, ID= ID_data, G = G_data, period = period_data, X=X_data,
                             ...
                             base_period = 5, data = sim_data, type = "Boot", B = 10))
   ...
   expect_error(maxEquivTest(Y= Y_data[1:100], ID= ID_data, G = G_data, period = period_data, X=X_data, equiv_threshold = 1, pretreatment_period = 1:5,
                             base_period = 5, type = "Boot", B = 10))
   expect_error(maxEquivTest(Y= Y_data, ID= ID_data[1:100], G = G_data, period = period_data, X=X_data, equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, type = "Boot", B = 10))
   expect_error(maxEquivTest(Y= Y_data, ID= ID_data, G = G_data[1:100], period = period_data, X=X_data, equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, type = "Boot", B = 10))
   expect_error(maxEquivTest(Y= Y_data, ID= ID_data, G = G_data, period = period_data[1:100], X=X_data, equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, type = "Boot", B = 10))
   expect_error(maxEquivTest(Y= Y_data, ID= ID_data, G = G_data, period = period_data, X=X_data[1:100,], equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, type = "Boot", B = 10))
# 
   ...
   expect_error(maxEquivTest(Y= c(1,3), ID= 1, G = 4, period = 2, X=c(5,6), data = sim_data,
                             equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, type = "Boot", B = 10))
...
#   # Expect error if G is not a logical vector:
   expect_error(maxEquivTest(Y= 3, ID= 1, G = 1, period = 2, X=c(5,6), data = sim_data,
                             equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, type = "Boot", B = 100))
 ...
 test_that("Remaining data inputs for type = boot of maxEquivTest",{
  ...
  expect_error(maxEquivTest(Y= 3, ID= 1, G = 4, period = 2, X=c(5,6), cluster =7, data = sim_data,
                            equiv_threshold = 1, pretreatment_period = 1:5, base_period = 6, type = "Boot", B = 10))

  # Expect error if equiv threshold is negative or not an numeric value or not a scalar:
  expect_error(maxEquivTest(Y= 3, ID= 1, G = 4, period = 2, X=c(5,6), cluster =7, data = sim_data,
                            equiv_threshold = -1, pretreatment_period = 1:5, base_period = 5, type = "Boot", B = 100))
  expect_error(maxEquivTest(Y= 3, ID= 1, G = 4, period = 2, X=c(5,6), cluster =7, data = sim_data,
                      equiv_threshold = "a", pretreatment_period = 1:5, base_period = 5, type = "Boot", B = 10))
  expect_error(maxEquivTest(Y= 3, ID= 1, G = 4, period = 2, X=c(5,6), cluster =7, data = sim_data,
                            equiv_threshold = c(1,2), pretreatment_period = 1:5, base_period = 5, type = "Boot", B = 10))

  # Expect error if alpha is negative or higher than 1 or lower than 0:
  expect_error(maxEquivTest(Y= 3, ID= 1, G = 4, period = 2, X=c(5,6), cluster =7, data = sim_data,
                            equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, alpha = -0.05, type = "Boot", B = 10))
  expect_error(maxEquivTest(Y= 3, ID= 1, G = 4, period = 2, X=c(5,6), cluster =7, data = sim_data,
                            equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, alpha = 0, type = "Boot", B = 10))
  expect_error(maxEquivTest(Y= 3, ID= 1, G = 4, period = 2, X=c(5,6), cluster =7, data = sim_data,
                            equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, alpha = 1.01, type = "Boot", B = 10))
  # Expect error if alpha is not numeric:
  expect_error(maxEquivTest(Y= 3, ID= 1, G = 4, period = 2, X=c(5,6), cluster =7, data = sim_data,
                            equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, alpha = "a", type = "Boot", B = 10))

  # Expect error if B is non-integer or non-numeric or negative:
  expect_error(maxEquivTest(Y= 3, ID= 1, G = 4, period = 2, X=c(5,6), cluster =7, data = sim_data,
                            equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, B = 10.5, type = "Boot"))
  expect_error(maxEquivTest(Y= 3, ID= 1, G = 4, period = 2, X=c(5,6), cluster =7, data = sim_data,
                            equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, B = "a", type = "Boot"))
  expect_error(maxEquivTest(Y= 3, ID= 1, G = 4, period = 2, X=c(5,6), cluster =7, data = sim_data,
                            equiv_threshold = 1, pretreatment_period = 1:5, base_period = 5, B = -100, type = "Boot"))
