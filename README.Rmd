...
The `EquiTrends` package contains functions to test for equivalence of pre-trends in difference-in-differences estimation. The functions `maxEquivTest`, `meanEquivTest`, and `rmsEquivTest` are used to test for equivalence of pre-trends in difference-in-differences estimation using the placebo coefficients $\beta_{l} \; (l=1,...,T)$ estimates. The functions are based on the work of Dette & Schumann ([2024](https://doi.org/10.1080/07350015.2024.2308121)).
...
$$||\beta||_\infty = \max_{l=1,...T} |\beta_l|,$$ 
